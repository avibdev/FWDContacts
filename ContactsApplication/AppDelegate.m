...
//  ContactsApplication
//
//  Created by Banisetty Avinash on 21/10/19.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    FWDContactsViewController *contactsVC = (FWDContactsViewController *)self.window.rootViewController;
    
    FWDNetworkContactsLibrary *contactsLibrary = [[FWDNetworkContactsLibrary alloc] init];
